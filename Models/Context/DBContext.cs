...
public class DBContext : DbContext
{
    ...
    public DbSet<ProgramacionRiego> ProgramacionesRiego { get; set; }
    public DbSet<ProgramacionRele> ProgramacionReles { get; set; }

    public DbSet<EjecucionProgramacion> EjecucionesProgramacion { get; set; }
    public DbSet<EjecucionReleDetalle> EjecucionReleDetalles { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EjecucionProgramacion>()
        .HasIndex(e => new { e.idProgramacion, e.fecha })
        .IsUnique();
    }
